      ...
      <div className={styles.card}>
        ...
        <div className={styles.header}>
          ...
          <p className={styles.subtitle}>
            Sign in to continue your data intelligence journey.
          </p>
        </div>
        ...
        <div className={styles.socialButtons}>
          ...
          {/* Email/Mail */}
          <button type="button" className={styles.socialButton} aria-label="Sign in with Email">
